...
import org.zowe.data.sets.services.zosmf.ZosmfDataSetService;
import org.zowe.data.sets.services.zss.ZssDataSetService;
...
public class DataSetsController {
    ...
    @Autowired
    @Qualifier("zosmfDataSetService")
    private ZosmfDataSetService zosmfService;

    @Autowired
    @Qualifier("zssDataSetService")
    private ZssDataSetService zssService;

    @Autowired
    private ConnectorProperties properties;

    private DataSetService getDataSetService() {
        if ("zss".equals(properties.getConnector())) {
            return zssService;
        } else {
            return zosmfService;
        }
